  ...
  createDb() {
    ...
    let comSupportList = [
      {
        ...
        "synopsis": "NMRbox Documentation",
        "description": "Support document content will go here....",
        "descriptionHtml":"<h2>Account Creation</h2><p>After you register for an account, the NMRbox staff will validate your academic, government, or not-for-profit status and you will receive a welcome email with your username and temporary account password.</p><h2>Accessing your dedicated NMRbox VM</h2><p>Use the RealVNC Connect to access your NMRbox VM at: username.nmrbox.org on the default port 5900.</p><p>For step-by-step instructions, consult the following quick start guides:</p><ul><li>Quick Start (OSX)</li><li>Quick Start (Windows)</li></ul><p>Note: NMRbox servers require that you use RealVNC as your VNC client.</p><h2>Password Management</h2><p>You can reset your account password according to the instructions posted here.</p><h2>User Dashboard</h2><p>A Login button has been added to the homepage in the top right menu bar. This connects you to your user profile, which is your personalized entry point to NMRbox resources.  The dashboard will continue to evolve with new features and currently allows for profile and password management.</p><h2>General Information</h2><p>NMRbox FAQs (this static PDF is being migrated into the dynamic FAQ manager).<br/>Primer on using the terminal<br/>Support is available at: support@nmrbox.org</p><h2>Release Notes</h2><p>Release v2.0<br/>Release v1.0 (beta)</p>",
        "nmrbox_version":"5.1",
        "software_version":"11.0.5",
    ...
    let comBlogList = [
      {
        ...
        "url": "assets/temp-content/community/blog-1.jpg",
        ...
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
        "dateCurrent": true,
        "dateCurrentStr": "true"
      },
      {
        ...
        "synopsis": "Synopsis goes here",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/blog-2.jpg",
        "author": "Adam D. Schuyler, Ph.D.",
        "authorTitle": "Assistant Professor of Molecular Biology and Biophysics",
        "authorEmail": "schuyler@uchc.edu",
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
      ...
      },
      {
        ...
        "synopsis": "Brief synopsis",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/blog-3.jpg",
        "author": "Adam D. Schuyler, Ph.D.",
        "authorTitle": "Assistant Professor of Molecular Biology and Biophysics",
        "authorEmail": "schuyler@uchc.edu",
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
      ...
      },
      {
        ...
        "synopsis": "Synopsis goes here...",
        "description": "NMRPipe is an extensive software system for processing, analyzing, and exploiting NMR spectroscopic data. An NMRPipe installation also provides the applications NMRDraw, NMRWish, TALOS+, SPARTA+, DYNAMO, DC, MFR, ACME, and others. NMRPipe is an extensive software system for processing, analyzing, and exploiting NMR spectroscopic data. An NMRPipe installation also provides the applications NMRDraw, NMRWish, TALOS+, SPARTA+, DYNAMO, DC, MFR, ACME, and others.",
        "url": "assets/temp-content/community/blog-4.jpg",
        "author": "Adam D. Schuyler, Ph.D.",
        "authorTitle": "Assistant Professor of Molecular Biology and Biophysics",
        "authorEmail": "schuyler@uchc.edu",
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
      ...
      },
      {
        ...
        "synopsis": "Synopsis goes here...",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/blog-5.jpg",
        "author": "Adam D. Schuyler, Ph.D.",
        "authorTitle": "Assistant Professor of Molecular Biology and Biophysics",
        "authorEmail": "schuyler@uchc.edu",
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
      ...
      },
      {
        ...
        "synopsis": "Synopsis goes here...",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/blog-6.jpg",
        "author": "Adam D. Schuyler, Ph.D.",
        "authorTitle": "Assistant Professor of Molecular Biology and Biophysics",
        "authorEmail": "schuyler@uchc.edu",
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
      ...
      },
      {
        ...
        "synopsis": "Synopsis goes here...",
        "description": "NMRPipe is an extensive software system for processing, analyzing, and exploiting NMR spectroscopic data. An NMRPipe installation also provides the applications NMRDraw, NMRWish, TALOS+, SPARTA+, DYNAMO, DC, MFR, ACME, and others. NMRPipe is an extensive software system for processing, analyzing, and exploiting NMR spectroscopic data. An NMRPipe installation also provides the applications NMRDraw, NMRWish, TALOS+, SPARTA+, DYNAMO, DC, MFR, ACME, and others.",
        "url": "assets/temp-content/community/blog-7.jpg",
        "author": "Adam D. Schuyler, Ph.D.",
        "authorTitle": "Assistant Professor of Molecular Biology and Biophysics",
        "authorEmail": "schuyler@uchc.edu",
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
      ...
      },
      {
        ...
        "synopsis": "Synopsis goes here...",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/blog-8.jpg",
        "author": "Adam D. Schuyler, Ph.D.",
        "authorTitle": "Assistant Professor of Molecular Biology and Biophysics",
        "authorEmail": "schuyler@uchc.edu",
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
      ...
      },
      {
        ...
        "synopsis": "Synopsis goes here...",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/blog-9.jpg",
        "author": "Adam D. Schuyler, Ph.D.",
        "authorTitle": "Assistant Professor of Molecular Biology and Biophysics",
        "authorEmail": "schuyler@uchc.edu",
        "authorPhotoUrl": "assets/temp-content/community/blog-author.jpg",
    ...
    let comEventsList = [

      {
        ...
        "synopsis": "Synopsis goes here",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/events-4.jpg",
        "dateCurrent": true,
        "nmrbox_version":"5.1",
        "software_version":"6.5",
        "software_types": ['spectral']
      },
      {
        ...
        "url": "assets/temp-content/community/events-1.jpg",
        "dateCurrent": true,
        "nmrbox_version":"5.1",
        "software_version":"11.0.5",
        "software_types": ['spectral','assignment','relaxation','chemical-shift','molecular-modeling','structure','residual-dipole-coupling']
      },
      {
        ...
        "synopsis": "Brief synopsis",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/events-2.jpg",
        "dateCurrent": true,
        "nmrbox_version":"5.1",
        "software_version":"6.5",
        "software_types": ['spectral']
      },
      {
        ...
        "synopsis": "Synopsis goes here",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/events-3.jpg",
        "dateCurrent": false,
        "nmrbox_version":"5.1",
        "software_version":"6.5",
        "software_types": ['spectral']
      },
      {
        ...
        "synopsis": "Synopsis goes here",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/events-5.jpg",
        "dateCurrent": false,
        "nmrbox_version":"5.1",
        "software_version":"6.5",
        "software_types": ['spectral']
      },
      {
        ...
        "synopsis": "Synopsis goes here",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/events-6.jpg",
        "dateCurrent": false,
        "nmrbox_version":"5.1",
        "software_version":"6.5",
        "software_types": ['spectral']
      },
      {
        ...
        "synopsis": "Synopsis goes here",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/events-7.jpg",
        "dateCurrent": false,
        "nmrbox_version":"5.1",
        "software_version":"6.5",
        "software_types": ['spectral']
      },
      {
        ...
        "synopsis": "Synopsis goes here",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/events-8.jpg",
        "dateCurrent": false,
        "nmrbox_version":"5.1",
        "software_version":"6.5",
        "software_types": ['spectral']
      },
      {
        ...
        "synopsis": "Synopsis goes here",
        "description": "Article content will go here....",
        "url": "assets/temp-content/community/events-9.jpg",
        "dateCurrent": false,
        "nmrbox_version":"5.1",
        "software_version":"6.5",
        "software_types": ['spectral']
