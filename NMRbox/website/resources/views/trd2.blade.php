        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <div class="research-header">
                    <h1>Technology Research and Development - TR&amp;D 2</h1>
                ...
                <div class="research-container">
                    ...
                    <p> <strong> <em> CONNJUR/BMRB integration overview. </em> </strong> BMRB has developed APIs for the NMRbox platform and integration with CONNJUR that sit on the user’s NMRbox desktop and allow access to BMRB relational database queries, to DEVise data visualizations, to a CS-Rosetta structure calculation server, and to a BMRB archive FASTA search engine. CONNJUR support for NMR data incorporation into a NMR-STAR compliant data model will provide the infrastructure required to support the proposed development of BMRB archive data retrieval and deposition and access to BMRB SaaS facilities for users of the NMRbox platform. These platform enhancements will dramatically ease the exploration of publicly available data, improve the quality and completeness of data depositions, and support reproducible research.&nbsp; </p>
                    ...
                    <p><strong>Extend the CONNJUR data model and CONNJUR software integration environment to capture all relevant metadata required to save the state of both an ongoing and completed biomolecular NMR study. </strong> The capture of all information - the raw NMR data, the software tools and protocols for computation, and the manual steps and decision-making of the spectroscopist - will significantly enhance the data processing experience. For example, this will allow the analysis and reproduction of critical steps in the workflow of a study, reuse of particularly efficient workflow components, reflection on decisions and computational steps in assessing the validity of a study, and comparison of workflow methods. </p>
                    <p><strong>Enable CONNJUR as a direct deposition engine for the BMRB, PDB, and the NIH metabolomics Data Repository and Coordinating Center (DRCC). </strong> The full CONNJUR implementation, developed as <strong> Aim T2.1 </strong> , will inherently maintain all of the relevant NMRbox application metadata generated/used during a biomolecular or metabolomic NMR study. Tools will be developed to organize these data into a form that can be deposited at the appropriate public database.&nbsp; </p>
                    <p><strong>Construct machine-to-machine (M2M) infrastructure for future automated access to BMRB resources. </strong> The productivity of researchers using the NMRbox would be enhanced through automated and proactive extraction and presentation of information relevant to their research located in the BMRB archive. Infrastructure will be developed which will assist in the future integration of BMRB services. </p>
                    <p class="text-center">
