            ...
            <div class="panel panel-primary ">
                ...
                <div class="panel-body table_fluid">
                    <table id="vm-table" class="table table-bordered">
                        ...
                        <tbody>
                        @if(!empty($all_vm_downloads))
                            @foreach ($all_vm_downloads as $download)
                                <tr>
                                    <td>{!! $download->person_id !!}</td>
                                    <td>
                                    ...
                                    <td class="col-md-1">
                                        {{--<a href="{!! URL::to('admin/email/' . $download->person_id . '/edit' ) !!}"><i class="fa fa-fw fa-pencil text-warning" title="Update email template"></i></a>--}}
